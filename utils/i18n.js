...
const productImages = {
  "kebab-nyars": "/images/optimized/products/kebab-nyars-640.jpg",
  saslik: "/images/products/saslik.jpeg",
  elosutott: "/images/products/sultkebab.jpeg",
  kulonlegessegek: "/images/optimized/products/kulonlegessegek-640.jpg",
  joghurtok: "/images/optimized/products/joghurtok-640.jpg",
  pitak: "/images/optimized/products/pitak-640.jpg",
  pitas: "/images/optimized/products/pitak-640.jpg",
  tortillak: "/images/optimized/products/tortillak-640.jpg",
  tortillas: "/images/optimized/products/tortillak-640.jpg",
  desszertek: "/images/optimized/products/desszertek-640.jpg",
  desserts: "/images/optimized/products/desszertek-640.jpg",
  "kiegeszitok-csomagolas": "/images/optimized/products/kiegeszitok-csomagolas-640.jpg",
  "extras-packaging": "/images/optimized/products/kiegeszitok-csomagolas-640.jpg",
  "extras-verpackung": "/images/optimized/products/kiegeszitok-csomagolas-640.jpg",
};
...
logisticsRegions.hu = [
  ...
  { key: "centralDunantul", title: "K\u00f6z\u00e9p-Dun\u00e1nt\u00fal", schedule: "Szerda", text: "A k\u00f6z\u00e9ps\u0151 dun\u00e1nt\u00fali partnereket tervezett heti fordul\u00f3val, kisz\u00e1m\u00edthat\u00f3 h\u0171t\u00f6tt kiszolg\u00e1l\u00e1ssal \u00e9rj\u00fck el." },
  { key: "westDunantul", title: "Nyugat-Dun\u00e1nt\u00fal", schedule: "Szerda", text: "Nyugati partnereinket stabil \u00fatvonalon, el\u0151re egyeztetett \u00e1tad\u00e1ssal \u00e9s megb\u00edzhat\u00f3 h\u0171t\u0151l\u00e1nccal szolg\u00e1ljuk ki." },
...
logisticsRegions.en = [
  ...
  { key: "centralDunantul", title: "Central Transdanubia", schedule: "Wednesday", text: "A planned weekly refrigerated route for central Transdanubian partners with predictable handover windows." },
  { key: "westDunantul", title: "Western Transdanubia", schedule: "Wednesday", text: "Stable western route coverage with pre-arranged delivery rhythm and reliable cold-chain service." },
...
logisticsRegions.de = [
  ...
  { key: "centralDunantul", title: "Mittel-Transdanubien", schedule: "Mittwoch", text: "Geplante w\u00f6chentliche K\u00fchlroute f\u00fcr Partner in Mittel-Transdanubien mit berechenbaren Lieferfenstern." },
  { key: "westDunantul", title: "West-Transdanubien", schedule: "Mittwoch", text: "Stabile westliche Routenabdeckung mit abgestimmtem Lieferrhythmus und verl\u00e4sslicher K\u00fchlkette." },
...
const logisticsPanelPositions = {
  ...
  centralDunantul: "panel-top-right",
  westDunantul: "panel-bottom-right",
...
// Client feedback corrections - May 2026
copy.hu.home.advantageItems[1] = "A legrégebbi hazai gyros gyártó üzem";
copy.en.home.advantageItems = ["Controlled production based on domestic raw materials", "The oldest Hungarian gyros production plant", "In-house refrigerated fleet", "Traceable products with stable quality"];
copy.de.home.advantageItems = ["Kontrollierte Produktion auf Basis heimischer Rohstoffe", "Der älteste ungarische Gyros-Produktionsbetrieb", "Eigene gekühlte Fahrzeugflotte", "Rückverfolgbare Produkte mit stabiler Qualität"];

copy.hu.home.productsIntro = "Termékkínálatunk gyros- és kebab tömböket, pitát, fűszerezett és pácolt húskészítményeket, valamint egyéb hús specialitásokat foglal magában — megrendelésre bármilyen receptúrával.";
copy.en.home.productsIntro = "Our product range includes gyros and kebab blocks, pita, seasoned and marinated meat specialities, and other meat products — made to any recipe on request.";
copy.de.home.productsIntro = "Unser Sortiment umfasst Gyros- und Kebabblöcke, Pita, gewürzte und marinierte Fleischspezialitäten sowie weitere Fleischwaren — auf Wunsch nach individueller Rezeptur.";

copy.hu.about.introText[3] = "A Halasi Kebpro Kft.-nek exportjoga van, amely folyamatos állatorvosi ellenőrzést is garantál. A kebab/gyros-hús tömbökön kívül saslikot, májjal töltött combfilét és egyéb termékeket is gyártunk.";
copy.en.about.introText[3] = "Halasi Kebpro Kft. holds export rights, supported by continuous veterinary control. In addition to kebab/gyros meat blocks, we also produce shashlik, liver-stuffed thigh fillet and other products.";
copy.de.about.introText[3] = "Die Halasi Kebpro Kft. verfügt über eine Exportlizenz, die auch eine kontinuierliche veterinärmedizinische Überwachung gewährleistet. Neben Kebab-/Gyrosfleischblöcken stellen wir auch Schaschlik, lebergefüllte Oberschenkelfilets und weitere Produkte her.";

copy.hu.quality.sections.process.steps[1] = "A beszállított áru hőmérsékletét és minőségét szakképzett kollégáink vizsgálják.";
copy.en.quality.sections.process.steps[1] = "Incoming goods are checked by our qualified staff.";
copy.de.quality.sections.process.steps[1] = "Die eingehende Ware wird von unseren qualifizierten Mitarbeitenden geprüft.";
